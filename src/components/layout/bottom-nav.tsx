...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-gray-200 bg-white" style={{ paddingBottom: 'max(var(--safe-area-bottom, 0px), env(safe-area-inset-bottom, 0px))' }}>

...
export default function PostActionBar({ postId, initialBookmarked, shareData }: PostActionBarProps) {
  ...
  return (
    <>
      ...
      {shareData && (
        <ShareBottomSheet open={shareOpen} onClose={() => setShareOpen(false)} shareData={shareData} />
      )}
    </>
  );
}
